...
<html>
    ...
    <body>
        <div class="center">
            @if ($data->store->store_logo_base64)
                <img src="{{$data->store->store_logo_base64}}" width="90"/>
            @endif
        </div>
        <div class='center border-bottom-dashed pb-1rem'>
            <div class='bold display-block center'>{{ $data->store->name }}</div>
                {{ $data->store->address }}
            ...
            @if ($data->store->tax_number != '')
                <div class="center">VAT: {{ $data->store->tax_number }}</div>
            @endif
            @if ($data->store->primary_contact != '')
                <div class="center">Contact No: {{ $data->store->primary_contact }}</div>
            @endif
        </div>
        ...
        <div class='center'>
            <div class='display-block'>{{ $data->store->final_letter }}</div>
        </div>
